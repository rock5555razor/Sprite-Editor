...
namespace SpriteEditor
{
    public partial class frmPreview : Form
    {
        ...
        //private int _formWidth = 350;
        //private int _formHeight = 155;
        ...
        public frmPreview(List<Image> images, List<String> imageLocations, ref TreeView tree)
        {
            ...
            try
            {
                ...
                Dictionary<string, string> defaultInfo = keys.ToDictionary<string, string, string>(s => s, s => null);
                ...
                foreach (TreeNode n in tree.Nodes[0].Nodes)
                {
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrEmpty(cropInfo["flipX"]) && cropInfo["flipX"].Equals("1"))
                        {
                            ...
                            enc.Start(ms);
                            enc.SetDelay(delay);
                            enc.SetTransparent(Color.Transparent);
                            ...
                            enc.Finish();
                            imageToProcess = Image.FromStream(ms);
                        }
                    }
            ...
            {
                MessageBox.Show("Action aborted.\r\nDid the sprite load its image correctly or have you not specified an image uri?\n\nDetails:\n" + ex.Message,
        ...
        private void cmbStateToPreview_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //this.Width = _formWidth + previewBox.Image.Width;
            //this.Height = _formHeight + previewBox.Image.Height;
        }
